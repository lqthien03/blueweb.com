                ...
                <div class="container position-relative">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-6 text-center">
                            <h2>Domain</h2>
                            <p>Chào mừng bạn đến với dịch vụ quản lý tên miền của chúng tôi, nơi chúng tôi không chỉ giúp bạn đăng ký tên miền một cách dễ dàng mà còn đem đến nhiều giá trị gia tăng khác nhau. Dưới đây là những điểm nổi bật về dịch vụ quản lý tên miền của chúng tôi.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-4">
                <div class="col-lg-5 col-md-12 footer-info">
                    ...
                    <div class="social-links d-flex mt-4">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=61554409901863" class="facebook"><i
